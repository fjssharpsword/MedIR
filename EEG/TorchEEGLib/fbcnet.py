...
#https://github.com/torcheeg/torcheeg/blob/main/torcheeg/models/cnn/fbcnet.py
...
if __name__ == "__main__":
    x = torch.rand(10, 18, 512).to("cuda:5")
    model = FBCNet(in_channels=1, num_electrodes=18, chunk_size = 512, num_classes=2).to("cuda:5")
    out = model(x)
    print(out.shape)