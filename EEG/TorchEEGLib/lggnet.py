...
#https://github.com/torcheeg/torcheeg/blob/main/torcheeg/models/gnn/lggnet.py
...
if __name__ == "__main__":
    ...
    model = LGGNet(in_channels=1, num_electrodes=18, chunk_size = 512, num_classes=2).to("cuda:5")
    out = model(x)
    print(out.shape)