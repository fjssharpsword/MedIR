...
"""
https://github.com/Ycblue/TransMIL/blob/e48481c35b66085fd897e7fb8fb5ede24d60c22f/model.py#L5
...
if __name__ == '__main__':
    ...
    #
    # y = model(x, mask=mask)  # (1, 16384, 512)
    # print(y.shape)
    ...
    y = attn(x, mask=mask)  # (1, 16384, 512)
    print(y.shape)
