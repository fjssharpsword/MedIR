...
class Conv2d_Gaussian_fix(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1,
                 padding=1, dilation=1, groups=1, bias=False, theta=0.7):

        super(Conv2d_Gaussian_fix, self).__init__()
        ...
        for h_dim in hidden_dims:
            modules.append(
                nn.Sequential(
                    ...
                    Conv2d_Gaussian_fix(in_channels, out_channels=h_dim, kernel_size= 3, stride= 2, padding  = 1),
